...
public class Day2DayCategoriesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_categories_day_2_day);
        utils=new Utils(Day2DayCategoriesActivity.this);
    ...
    private void getCartTotal(String customer_id) {
        ...
        restService.getCartTotal(customer_id, new RestCallback<CartTotalRequest>() {
            ...
            public void invalid() {
                ...
                Toast.makeText(Day2DayCategoriesActivity.this, "Problem while fetching items list", Toast.LENGTH_LONG).show();
            ...
            public void failure() {
                ...
                Toast.makeText(Day2DayCategoriesActivity.this, "Error parsing items list", Toast.LENGTH_LONG).show();
    ...
    private void initFields(){
        ...
        lin_cart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Day2DayCategoriesActivity.this, AddToCartListAllItemsActivity.class);
                intent.putExtra("context_act1", "webskitters.com.stockup.Day2DayCategoriesActivity");
        ...
        img_landing_icon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Day2DayCategoriesActivity.this, LandingActivity.class);
                startActivity(intent);
                finish();
                overridePendingTransition(R.anim.slide_right_in, R.anim.slide_right_out);
        ...
        linSeeAll.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                toEdit.putString(Constants.strShUserProductId, "12");
                toEdit.putString(Constants.strShStoreID, "yes");
                toEdit.commit();
                Intent intent = new Intent(Day2DayCategoriesActivity.this, SubCategoryActivity.class);
        ...
        //gridview.setAdapter(new Day2DayCatAdapter(Day2DayCategoriesActivity.this, arrCatName));
        ...
        gridview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View v,
                ...
                Intent intent = new Intent(Day2DayCategoriesActivity.this, SubCategoryActivity.class);
                intent.putExtra("cat_type", "Day2Day");
                startActivity(intent);
    ...
    private void getDialogSearch() {
        final Dialog dialog = new Dialog(Day2DayCategoriesActivity.this, android.R.style.Theme_Black_NoTitleBar_Fullscreen);
        ...
        img_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                hideSoftKeyboard(Day2DayCategoriesActivity.this);
                if(dialog.isShowing())
                    dialog.dismiss();
            }
        });
        img_search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                openSOftKeyboard(Day2DayCategoriesActivity.this, et_search);
            }
        });
    ...
    private void getAutoSearchKey(final String strSearch, final Dialog dialog, final ListView lv) {
        ...
        restService.getAutoSearch(strSearch, "12", new RestCallback<SearchResultRequest>() {
                ...
                if (reqStatus == 200 && reqSuccess == 1) {
                    ...
                    AdapterView.OnItemClickListener itemClickListener = new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> arg0, View arg1, int position, long id) {
                            ...
                            toEdit.commit();
                            //dialog.dismiss();
                            Intent intent = new Intent(Day2DayCategoriesActivity.this, ProductDetailsActivity.class);
                            finish();
                            startActivity(intent);
    ...
    private void getSubCateoryList(String address, String store_id) {
        ...
        restService.mainCategoryList(address, store_id, new RestCallback<MainCategoryRequest>() {
            ...
            public void success(MainCategoryRequest object) {
                ...
                gridview.setAdapter(new DrinksCatAdapter(Day2DayCategoriesActivity.this, object.getData().getSubCategoryList()));
            ...
            public void invalid() {
                ...
                Toast.makeText(Day2DayCategoriesActivity.this, "Problem while fetching tracking list", Toast.LENGTH_LONG).show();
            ...
            public void failure() {
                ...
                Toast.makeText(Day2DayCategoriesActivity.this, "Error parsing tracking list", Toast.LENGTH_LONG).show();
    ...
    private void getDialogCoverage() {
        final Dialog dialog = new Dialog(Day2DayCategoriesActivity.this);
        Window window = dialog.getWindow();
        dialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
    ...
    public void onBackPressed() {
        ...
        if (drawer != null && drawer.isDrawerOpen(GravityCompat.START)) {
            ...
            toEdit.commit();
            Intent intent=new Intent(Day2DayCategoriesActivity.this, PinCodeActivity.class);
            startActivity(intent);
            finish();
            Day2DayCategoriesActivity.this.overridePendingTransition(android.R.anim.slide_in_left, android.R.anim.slide_out_right);
        }
    ...
    private void setDrawerMenu() {
        ...
        listAdapter = new MenuListAdapter(Day2DayCategoriesActivity.this, slideMenuOptions);
        ...
        footerView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                closeDrawer(0);
                ConfirmationDialog confirmationDialog = new ConfirmationDialog(Day2DayCategoriesActivity.this, DialogType.LOGOUT, new ConfirmationDialog.Confiramtion() {
                    @Override
                    public void accept() {
                        //logOut();
                    }
    ...
    private void optionSelefctedNew(int id) {
        ...
        switch (id){
            case 3:
                Intent intentAddToCart=new Intent(Day2DayCategoriesActivity.this, AddToCartListAllItemsActivity.class);
            ...
            case 4:
                if(!customer_id.equalsIgnoreCase("")){
                    ...
                    Intent intentSign=new Intent(Day2DayCategoriesActivity.this, LoginActivity.class);
            ...
            case 6:
                ...
                Intent intentDay2Day=new Intent(Day2DayCategoriesActivity.this, DrinkCategoriesActivity.class);
            ...
            case 7:
                ...
                toEdit.commit();
                Intent intentFoods=new Intent(Day2DayCategoriesActivity.this, FoodCategoriesActivity.class);
            ...
            case 8:
                ...
                toEdit.commit();
                /*Intent intentDay=new Intent(Day2DayCategoriesActivity.this, Day2DayCategoriesActivity.class);
            ...
            case 9:
                ...
                toEdit.commit();
                Intent intentGifts=new Intent(Day2DayCategoriesActivity.this, GiftCategoriesActivity.class);
            ...
            case 10:
                ...
                toEdit.commit();
                Intent intentEvents=new Intent(Day2DayCategoriesActivity.this, EventCategoriesActivity.class);
            ...
            case 11:
                ...
                if (customer_id.equalsIgnoreCase("")){
                    ...
                    Intent intentMyDetails = new Intent(Day2DayCategoriesActivity.this, MyDetailsActivity.class);
            ...
            case 13:
                ...
                if (customer_id.equalsIgnoreCase("")){
                    ...
                    Intent intentMyAddress = new Intent(Day2DayCategoriesActivity.this, MyAddressActivity.class);
            ...
            case 14:
                ...
                if (customer_id.equalsIgnoreCase("")){
                    ...
                    Intent intentMyWishList = new Intent(Day2DayCategoriesActivity.this, MyWishListActivity.class);
            ...
            case 15:
                ...
                if (customer_id.equalsIgnoreCase("")){
                    ...
                    Intent intentShoppingList = new Intent(Day2DayCategoriesActivity.this, MyShoppingListActivity.class);
            ...
            case 16:
                ...
                if (customer_id.equalsIgnoreCase("")){
                    ...
                    Intent intentPastOrders = new Intent(Day2DayCategoriesActivity.this, PastOrderListActivity.class);
            ...
            case 17:
                ...
                Intent intentServe = new Intent(Day2DayCategoriesActivity.this, KenCommerceWebViewActivity.class);
            ...
            case 18:
                ...
                Intent intentFaq = new Intent(Day2DayCategoriesActivity.this, KenCommerceWebViewActivity.class);
            ...
            case 19:
                ...
                Intent urlPP = new Intent(Day2DayCategoriesActivity.this, KenCommerceWebViewActivity.class);
            ...
            case 20:
                ...
                Intent urlTandC = new Intent(Day2DayCategoriesActivity.this, KenCommerceWebViewActivity.class);
        ...
        switch (id){
            ...
            case 4:
                if(!customer_id.equalsIgnoreCase("")){
                    ...
                    Intent intentSign=new Intent(Day2DayCategoriesActivity.this, LoginActivity.class);
                    intentSign.putExtra("context_act1", "webskitters.com.stockup.Day2DayCategoriesActivity");
                    startActivity(intentSign);
                    overridePendingTransition(R.anim.slide_right_in, R.anim.slide_right_out);
                }
                break;
            ...
            case 8:
               // getDialogAge();
                if (strAge.equalsIgnoreCase("")) {
                    ...
                    toEdit.putString(Constants.strShUserStoreID, "10");
                    toEdit.commit();
                    Intent intentDrinks=new Intent(Day2DayCategoriesActivity.this, DrinkCategoriesActivity.class);
            ...
            case 19:
                getDialogCoverage();
                /*Intent intentTrackOrders=new Intent(Day2DayCategoriesActivity.this, TrackOrderListActivity.class);
    ...
    public void displayAlert(String message)
    {
        ...
        alertDialogBuilder.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                dialog.cancel();
                Intent intent=new Intent(Day2DayCategoriesActivity.this, LoginActivity.class);
                intent.putExtra("context_act1", "webskitters.com.stockup.Day2DayCategoriesActivity");
                finish();
                startActivity(intent);
            }
    ...
    private void doLogOut() {
        final ProgressDialog pDialog=new ProgressDialog(Day2DayCategoriesActivity.this);
        pDialog.show();
        ...
        restService.logOut(strCustId, new RestCallback<LogOutRequest>() {
            ...
            public void success(LogOutRequest responce) {
                ...
                if (reqStatus == 200 && reqSuccess == 1) {
                    ...
                    //Toast.makeText(Day2DayCategoriesActivity.this, "Successfully Logout", Toast.LENGTH_LONG).show();
                    ...
                    Toast.makeText(Day2DayCategoriesActivity.this, responce.getErrorMsg(), Toast.LENGTH_LONG).show();
                }
            }
