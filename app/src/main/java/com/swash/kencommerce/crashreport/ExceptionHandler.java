...
package com.swash.kencommerce.crashreport;
...
public class ExceptionHandler implements Thread.UncaughtExceptionHandler {
	...
	String extStorageDirectory = "/sdcard/KenCommerce/KenCommerce.txt";
	...
	public void uncaughtException(Thread thread, Throwable exception) {
        ...
        {
            cacheDir=new File(android.os.Environment.getExternalStorageDirectory(),"KenCommerce");
        }
        else
        ...
        if(!cacheDir.exists())
		    ...
		    if (cacheDir != null) 
		    {		     
		    	 cacheDir=new File(cacheDir,"KenCommerce.txt");
		    	
		    	writeToFile(stackTrace.toString(), cacheDir);
		    	email.sendMail(myContext, "krantibijaya@gmail.com.com",extStorageDirectory);
