...
public class GiftCategoriesActivity extends AppCompatActivity {
    ...
    private void getCartTotal(String customer_id) {
        ...
        restService.getCartTotal(customer_id, new RestCallback<CartTotalRequest>() {
            ...
            public void invalid() {
                ...
                Toast.makeText(GiftCategoriesActivity.this, "Problem while fetching items list", Toast.LENGTH_LONG).show();
            ...
            public void failure() {
                ...
                Toast.makeText(GiftCategoriesActivity.this, "Error parsing items list", Toast.LENGTH_LONG).show();
    ...
    private void initFields(){
        ...
        //arrCatName.add("Corporate Gifting");
        //arrCatName.add("Gifts for Her");
    ...
    private void optionSelefctedNew(int id) {
        ...
        switch (id){
            case 3:
                Intent intentAddToCart=new Intent(GiftCategoriesActivity.this, AddToCartListAllItemsActivity.class);
            ...
            case 6:
                ...
                Intent intentDay2Day=new Intent(GiftCategoriesActivity.this, DrinkCategoriesActivity.class);
            ...
            case 9:
                ...
                toEdit.commit();
                /*Intent intentGifts=new Intent(GiftCategoriesActivity.this, GiftCategoriesActivity.class);
            ...
            case 17:
                ...
                Intent intentServe = new Intent(GiftCategoriesActivity.this, KenCommerceWebViewActivity.class);
            ...
            case 18:
                ...
                Intent intentFaq = new Intent(GiftCategoriesActivity.this, KenCommerceWebViewActivity.class);
            ...
            case 19:
                ...
                Intent urlPP = new Intent(GiftCategoriesActivity.this, KenCommerceWebViewActivity.class);
            ...
            case 20:
                ...
                Intent urlTandC = new Intent(GiftCategoriesActivity.this, KenCommerceWebViewActivity.class);
    ...
    private void optionSelefcted(int id) {
        ...
        switch (id){
            ...
            case 19:
                getDialogCoverage();
                /*Intent intentTrackOrders=new Intent(GiftCategoriesActivity.this, TrackOrderListActivity.class);
