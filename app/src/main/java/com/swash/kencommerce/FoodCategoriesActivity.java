...
import com.swash.kencommerce.adapter.FoodsCatAdapter;
...
public class FoodCategoriesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        typeFaceSegoeuiReg = Typeface.createFromAsset(getAssets(),
                "Roboto-Regular.ttf");
        utils=new Utils(FoodCategoriesActivity.this);
    ...
    private void getCartTotal(String customer_id) {
        ...
        restService.getCartTotal(customer_id, new RestCallback<CartTotalRequest>() {
            ...
            public void invalid() {
                ...
                Toast.makeText(FoodCategoriesActivity.this, "Problem while fetching items list", Toast.LENGTH_LONG).show();
            ...
            public void failure() {
                ...
                Toast.makeText(FoodCategoriesActivity.this, "Error parsing items list", Toast.LENGTH_LONG).show();
    ...
    private void getSubCateoryList(String address, String store_id) {
        ...
        restService.mainCategoryList(address, store_id, new RestCallback<MainCategoryRequest>() {
            ...
            public void success(MainCategoryRequest object) {
                ...
                gridview.setAdapter(new DrinksCatAdapter(FoodCategoriesActivity.this, object.getData().getSubCategoryList()));
            ...
            public void invalid() {
                if (pDialog != null)
                    pDialog.dismiss();
                Toast.makeText(FoodCategoriesActivity.this, "Problem while fetching tracking list", Toast.LENGTH_LONG).show();
            }
            ...
            public void failure() {
                ...
                Toast.makeText(FoodCategoriesActivity.this, "Error parsing tracking list", Toast.LENGTH_LONG).show();
            }
        });
    ...
    private void getDialogSearch() {
        final Dialog dialog = new Dialog(FoodCategoriesActivity.this, android.R.style.Theme_Black_NoTitleBar_Fullscreen);
        ...
        img_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                hideSoftKeyboard(FoodCategoriesActivity.this);
                if(dialog.isShowing())
                    dialog.dismiss();
            }
        });
        img_search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                openSOftKeyboard(FoodCategoriesActivity.this, et_search);
            }
        });
    ...
    private void getAutoSearchKey(final String strSearch, final Dialog dialog, final ListView lv) {
        ...
        restService.getAutoSearch(strSearch, "11", new RestCallback<SearchResultRequest>() {
                ...
                if (reqStatus == 200 && reqSuccess == 1) {
                    ...
                    AdapterView.OnItemClickListener itemClickListener = new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> arg0, View arg1, int position, long id) {
                            ...
                            toEdit.putString(Constants.strShUserProductId, "11");
                            toEdit.putString(Constants.strShStoreID, "yes");
                            toEdit.commit();
                            //dialog.dismiss();
                            Intent intent = new Intent(FoodCategoriesActivity.this, ProductDetailsActivity.class);
                            finish();
    ...
    private void initFields(){
        ...
        lin_cart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FoodCategoriesActivity.this, AddToCartListAllItemsActivity.class);
                intent.putExtra("context_act1", "webskitters.com.stockup.FoodCategoriesActivity");
                startActivity(intent);
                finish();
        ...
        img_landing_icon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FoodCategoriesActivity.this, LandingActivity.class);
                startActivity(intent);
                finish();
                overridePendingTransition(R.anim.slide_right_in, R.anim.slide_right_out);
        ...
        linSeeAll.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                toEdit.putString(Constants.strShStoreID, "yes");
                toEdit.commit();
                Intent intent = new Intent(FoodCategoriesActivity.this, SubCategoryActivity.class);
       ...
       /* arrCatName.add("Test3");
        ...
        gridview.setAdapter(new FoodsCatAdapter(FoodCategoriesActivity.this, arrCatName));
        ...
        gridview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View v,
               ...
               /* Toast.makeText(DrinkCategoriesActivity.this, "" + position,
                ...
                //getDialogCoverage();
                Intent intent = new Intent(FoodCategoriesActivity.this, SubCategoryActivity.class);
                intent.putExtra("cat_type", "Foods");
                startActivity(intent);
                overridePendingTransition(R.anim.slide_right_in, R.anim.slide_right_out);
            }
        });
    ...
    private void getDialogCoverage() {
        final Dialog dialog = new Dialog(FoodCategoriesActivity.this);
        Window window = dialog.getWindow();
        dialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
    ...
    public void onBackPressed() {
        ...
        if (drawer != null && drawer.isDrawerOpen(GravityCompat.START)) {
            ...
            toEdit.commit();
            Intent intent=new Intent(FoodCategoriesActivity.this, PinCodeActivity.class);
            startActivity(intent);
            finish();
            FoodCategoriesActivity.this.overridePendingTransition(android.R.anim.slide_in_left, android.R.anim.slide_out_right);
        }
    ...
    private void setDrawerMenu() {
        ...
        listAdapter = new MenuListAdapter(FoodCategoriesActivity.this, slideMenuOptions);
        ...
        footerView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                closeDrawer(0);
                ConfirmationDialog confirmationDialog = new ConfirmationDialog(FoodCategoriesActivity.this, DialogType.LOGOUT, new ConfirmationDialog.Confiramtion() {
                    @Override
                    public void accept() {
                        //logOut();
                    }
    ...
    private void optionSelefctedNew(int id) {
        ...
        switch (id){
            case 3:
                Intent intentAddToCart=new Intent(FoodCategoriesActivity.this, AddToCartListAllItemsActivity.class);
            ...
            case 4:
                if(!customer_id.equalsIgnoreCase("")){
                    ...
                    Intent intentSign=new Intent(FoodCategoriesActivity.this, LoginActivity.class);
            ...
            case 6:
                ...
                Intent intentDay2Day=new Intent(FoodCategoriesActivity.this, DrinkCategoriesActivity.class);
            ...
            case 7:
                ...
                toEdit.commit();
                /*Intent intentFoods=new Intent(FoodCategoriesActivity.this, FoodCategoriesActivity.class);
            ...
            case 8:
                ...
                toEdit.commit();
                Intent intentDay=new Intent(FoodCategoriesActivity.this, Day2DayCategoriesActivity.class);
            ...
            case 9:
                ...
                toEdit.commit();
                Intent intentGifts=new Intent(FoodCategoriesActivity.this, GiftCategoriesActivity.class);
            ...
            case 10:
                ...
                toEdit.commit();
                Intent intentEvents=new Intent(FoodCategoriesActivity.this, EventCategoriesActivity.class);
            ...
            case 11:
                ...
                if (customer_id.equalsIgnoreCase("")){
                    ...
                    Intent intentMyDetails = new Intent(FoodCategoriesActivity.this, MyDetailsActivity.class);
            ...
            case 13:
                ...
                if (customer_id.equalsIgnoreCase("")){
                    ...
                    Intent intentMyAddress = new Intent(FoodCategoriesActivity.this, MyAddressActivity.class);
            ...
            case 14:
                ...
                if (customer_id.equalsIgnoreCase("")){
                    ...
                    Intent intentMyWishList = new Intent(FoodCategoriesActivity.this, MyWishListActivity.class);
            ...
            case 15:
                ...
                if (customer_id.equalsIgnoreCase("")){
                    ...
                    Intent intentShoppingList = new Intent(FoodCategoriesActivity.this, MyShoppingListActivity.class);
            ...
            case 16:
                ...
                if (customer_id.equalsIgnoreCase("")){
                    ...
                    Intent intentPastOrders = new Intent(FoodCategoriesActivity.this, PastOrderListActivity.class);
            ...
            case 17:
                ...
                Intent intentServe = new Intent(FoodCategoriesActivity.this, KenCommerceWebViewActivity.class);
            ...
            case 18:
                ...
                Intent intentFaq = new Intent(FoodCategoriesActivity.this, KenCommerceWebViewActivity.class);
            ...
            case 19:
                ...
                Intent urlPP = new Intent(FoodCategoriesActivity.this, KenCommerceWebViewActivity.class);
            ...
            case 20:
                ...
                Intent urlTandC = new Intent(FoodCategoriesActivity.this, KenCommerceWebViewActivity.class);
        ...
        switch (id){
            ...
            case 4:
                if(!customer_id.equalsIgnoreCase("")){
                    ...
                    Intent intentSign=new Intent(FoodCategoriesActivity.this, LoginActivity.class);
                    intentSign.putExtra("context_act1", "webskitters.com.stockup.FoodCategoriesActivity");
                    startActivity(intentSign);
                    overridePendingTransition(R.anim.slide_right_in, R.anim.slide_right_out);
                }
                break;
            ...
            case 8:
                if (strAge.equalsIgnoreCase("")) {
                    ...
                    toEdit.putString(Constants.strShUserStoreID, "10");
                    toEdit.commit();
                    Intent intentDrinks=new Intent(FoodCategoriesActivity.this, DrinkCategoriesActivity.class);
            ...
            case 9:
                ...
                toEdit.putString(Constants.strShUserStoreID, "11");
                toEdit.commit();
                /*Intent intentGifts=new Intent(FoodCategoriesActivity.this, FoodCategoriesActivity.class);
                startActivity(intentGifts);
                finish();*/
                break;
            case 10:
                ...
                toEdit.putString(Constants.strShUserStoreID, "12");
                toEdit.commit();
                Intent intentGifts=new Intent(FoodCategoriesActivity.this, Day2DayCategoriesActivity.class);
                startActivity(intentGifts);
                finish();
                overridePendingTransition(R.anim.slide_right_in, R.anim.slide_right_out);
                break;
            case 11:
                ...
                toEdit.putString(Constants.strShUserStoreID, "13");
                toEdit.commit();
                Intent intentDrinks=new Intent(FoodCategoriesActivity.this, GiftCategoriesActivity.class);
                startActivity(intentDrinks);
                finish();
                overridePendingTransition(R.anim.slide_right_in, R.anim.slide_right_out);
                break;
            ...
            case 19:
                getDialogCoverage();
                /*Intent intentTrackOrders=new Intent(FoodCategoriesActivity.this, TrackOrderListActivity.class);
    ...
    private void doLogOut() {
        final ProgressDialog pDialog=new ProgressDialog(FoodCategoriesActivity.this);
        pDialog.show();
            ...
            public void success(LogOutRequest responce) {
                ...
                if (reqStatus == 200 && reqSuccess == 1) {
                   ...
                   displayAlertLogOut("You have been signed out successfully.");
                    ...
                    Toast.makeText(FoodCategoriesActivity.this, responce.getErrorMsg(), Toast.LENGTH_LONG).show();
                }
                pDialog.dismiss();
            }
    ...
    public void displayAlert(String message)
    {
        ...
        alertDialogBuilder.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                dialog.cancel();
                Intent intent=new Intent(FoodCategoriesActivity.this, LoginActivity.class);
                intent.putExtra("context_act1", "webskitters.com.stockup.FoodCategoriesActivity");
                finish();
                startActivity(intent);
            }
