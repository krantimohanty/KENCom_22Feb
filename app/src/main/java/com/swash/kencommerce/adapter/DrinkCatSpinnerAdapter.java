 ...
 */
public class DrinkCatSpinnerAdapter extends BaseAdapter {
    private Context mContext;
    ArrayList<HashMap<String, String>> arrCatName;

    public DrinkCatSpinnerAdapter(Context c, ArrayList<HashMap<String, String>> arrCatName) {
        this.mContext = c;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.tvCatName.setText(arrCatName.get(position).get("ProductQnty").toString());
