 ...
 */
public class GiftsCatAdapter extends BaseAdapter {
    private final Typeface typeFaceSegoeuiReg;
    private Context mContext;
    ArrayList<String> arrCatName;

    public GiftsCatAdapter(Context c, ArrayList<String> arrCatName) {
        this.mContext = c;
    ...
    private Integer[] mThumbIds = {
            R.drawable.gifts_cat_1, R.drawable.gifts_cat_2,
            /*R.drawable.gifts_item_image, R.drawable.gifts_item_image,
            R.drawable.gifts_item_image, R.drawable.gifts_item_image,
            R.drawable.gifts_item_image, R.drawable.gifts_item_image,
            R.drawable.gifts_item_image,*/
    };
}
