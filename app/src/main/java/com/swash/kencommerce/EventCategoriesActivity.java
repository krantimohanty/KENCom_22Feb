...
/**
 * Created by kranti on 10/12/2016.
 */
public class EventCategoriesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_categories_events);
        typeFaceSegoeuiReg = Typeface.createFromAsset(getAssets(),
                "Roboto-Regular.ttf");
        restService=new RestService();
        utils=new Utils(EventCategoriesActivity.this);
    ...
    private void getCartTotal(String customer_id) {
        ...
        restService.getCartTotal(customer_id, new RestCallback<CartTotalRequest>() {
            ...
            public void invalid() {
                ...
                Toast.makeText(EventCategoriesActivity.this, "Problem while fetching items list", Toast.LENGTH_LONG).show();
            ...
            public void failure() {
                ...
                Toast.makeText(EventCategoriesActivity.this, "Error parsing items list", Toast.LENGTH_LONG).show();
    ...
    private void getSubCateoryList(String address, String store_id) {
        ...
        restService.mainCategoryList(address, store_id, new RestCallback<MainCategoryRequest>() {
            ...
            public void success(MainCategoryRequest object) {
                ...
                gridview.setAdapter(new DrinksCatAdapter(EventCategoriesActivity.this, object.getData().getSubCategoryList()));
            ...
            public void invalid() {
                ...
                Toast.makeText(EventCategoriesActivity.this, "Problem while fetching tracking list", Toast.LENGTH_LONG).show();
            ...
            public void failure() {
                ...
                Toast.makeText(EventCategoriesActivity.this, "Error parsing tracking list", Toast.LENGTH_LONG).show();
    ...
    private void initFields(){
        ...
        lin_cart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(EventCategoriesActivity.this, AddToCartListAllItemsActivity.class);
                intent.putExtra("context_act1", "webskitters.com.stockup.EventCategoriesActivity");
        ...
        img_landing_icon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(EventCategoriesActivity.this, LandingActivity.class);
                startActivity(intent);
                finish();
                overridePendingTransition(R.anim.slide_right_in, R.anim.slide_right_out);
        ...
        linSeeAll.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                toEdit.putString(Constants.strShUserProductId, "14");
                toEdit.putString(Constants.strShStoreID, "yes");
                toEdit.commit();
                Intent intent = new Intent(EventCategoriesActivity.this, SubCategoryActivity.class);
        ...
        arrCatName.add("Pizza");
        arrCatName.add("Sweets");
       *//* arrCatName.add("Test3");
        ...
        //gridview.setAdapter(new FoodsCatAdapter(EventCategoriesActivity.this, arrCatName));
        ...
        gridview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View v,
               ...
               /* Toast.makeText(DrinkCategoriesActivity.this, "" + position,
                ...
                //getDialogCoverage();
                Intent intent = new Intent(EventCategoriesActivity.this, SubCategoryActivity.class);
                intent.putExtra("cat_type", "Event");
                startActivity(intent);
                overridePendingTransition(R.anim.slide_right_in, R.anim.slide_right_out);
            }
        });
    ...
    private void getDialogSearch() {
        final Dialog dialog = new Dialog(EventCategoriesActivity.this, android.R.style.Theme_Black_NoTitleBar_Fullscreen);
        ...
        img_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                hideSoftKeyboard(EventCategoriesActivity.this);
                if(dialog.isShowing())
                    dialog.dismiss();
            }
        });
        img_search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                openSOftKeyboard(EventCategoriesActivity.this, et_search);
            }
        });
    ...
    private void getAutoSearchKey(final String strSearch, final Dialog dialog, final ListView lv) {
        ...
        restService.getAutoSearch(strSearch, "14", new RestCallback<SearchResultRequest>() {
                ...
                if (reqStatus == 200 && reqSuccess == 1) {
                    ...
                    AdapterView.OnItemClickListener itemClickListener = new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> arg0, View arg1, int position, long id) {
                            ...
                            toEdit.commit();
                            //dialog.dismiss();
                            Intent intent = new Intent(EventCategoriesActivity.this, ProductDetailsActivity.class);
                            finish();
                            startActivity(intent);
    ...
    private void getDialogCoverage() {
        final Dialog dialog = new Dialog(EventCategoriesActivity.this);
        Window window = dialog.getWindow();
        dialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
    ...
    public void onBackPressed() {
        ...
        if (drawer != null && drawer.isDrawerOpen(GravityCompat.START)) {
            ...
            Intent intent=new Intent(EventCategoriesActivity.this, PinCodeActivity.class);
            startActivity(intent);
            finish();
            EventCategoriesActivity.this.overridePendingTransition(android.R.anim.slide_in_left, android.R.anim.slide_out_right);
        }
    }
    ...
    private void setDrawerMenu() {
        ...
        listAdapter = new MenuListAdapter(EventCategoriesActivity.this, slideMenuOptions);
        ...
        footerView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                closeDrawer(0);
                ConfirmationDialog confirmationDialog = new ConfirmationDialog(EventCategoriesActivity.this, DialogType.LOGOUT, new ConfirmationDialog.Confiramtion() {
                    @Override
                    public void accept() {
                        //logOut();
                    }
    ...
    private void optionSelefctedNew(int id) {
        ...
        switch (id){
            case 3:
                Intent intentAddToCart=new Intent(EventCategoriesActivity.this, AddToCartListAllItemsActivity.class);
            ...
            case 4:
                if(!customer_id.equalsIgnoreCase("")){
                    ...
                    Intent intentSign=new Intent(EventCategoriesActivity.this, LoginActivity.class);
            ...
            case 6:
                ...
                Intent intentDay2Day=new Intent(EventCategoriesActivity.this, DrinkCategoriesActivity.class);
            ...
            case 7:
                ...
                toEdit.commit();
                Intent intentFoods=new Intent(EventCategoriesActivity.this, FoodCategoriesActivity.class);
            ...
            case 8:
                ...
                toEdit.commit();
                Intent intentDay=new Intent(EventCategoriesActivity.this, Day2DayCategoriesActivity.class);
            ...
            case 9:
                ...
                toEdit.commit();
                Intent intentGifts=new Intent(EventCategoriesActivity.this, GiftCategoriesActivity.class);
            ...
            case 10:
                ...
                toEdit.commit();
                Intent intentEvents=new Intent(EventCategoriesActivity.this, EventCategoriesActivity.class);
            ...
            case 11:
                ...
                if (customer_id.equalsIgnoreCase("")){
                    ...
                    Intent intentMyDetails = new Intent(EventCategoriesActivity.this, MyDetailsActivity.class);
            ...
            case 13:
                ...
                if (customer_id.equalsIgnoreCase("")){
                    ...
                    Intent intentMyAddress = new Intent(EventCategoriesActivity.this, MyAddressActivity.class);
            ...
            case 14:
                ...
                if (customer_id.equalsIgnoreCase("")){
                    ...
                    Intent intentMyWishList = new Intent(EventCategoriesActivity.this, MyWishListActivity.class);
            ...
            case 15:
                ...
                if (customer_id.equalsIgnoreCase("")){
                    ...
                    Intent intentShoppingList = new Intent(EventCategoriesActivity.this, MyShoppingListActivity.class);
            ...
            case 16:
                ...
                if (customer_id.equalsIgnoreCase("")){
                    ...
                    Intent intentPastOrders = new Intent(EventCategoriesActivity.this, PastOrderListActivity.class);
            ...
            case 17:
                ...
                Intent intentServe = new Intent(EventCategoriesActivity.this, KenCommerceWebViewActivity.class);
            ...
            case 18:
                ...
                Intent intentFaq = new Intent(EventCategoriesActivity.this, KenCommerceWebViewActivity.class);
            ...
            case 19:
                ...
                Intent urlPP = new Intent(EventCategoriesActivity.this, KenCommerceWebViewActivity.class);
            ...
            case 20:
                ...
                Intent urlTandC = new Intent(EventCategoriesActivity.this, KenCommerceWebViewActivity.class);
    ...
    private void optionSelefcted(int id) {
        ...
        switch (id){
            case 3:
                Intent intentAddToCart=new Intent(EventCategoriesActivity.this, AddToCartListAllItemsActivity.class);
                intentAddToCart.putExtra("context_act1", "webskitters.com.stockup.EventCategoriesActivity");
                startActivity(intentAddToCart);
                finish();
                overridePendingTransition(R.anim.slide_right_in, R.anim.slide_right_out);
                break;
            ...
            case 8:
                if (strAge.equalsIgnoreCase("")) {
                    ...
                    toEdit.putString(Constants.strShUserStoreID, "10");
                    toEdit.commit();
                    Intent intentDrinks=new Intent(EventCategoriesActivity.this, DrinkCategoriesActivity.class);
            ...
            case 9:
                ...
                toEdit.putString(Constants.strShUserShopSelected, Constants.strShUserShopGift);
                toEdit.commit();
                Intent intentFood=new Intent(EventCategoriesActivity.this, FoodCategoriesActivity.class);
            ...
            case 10:
                ...
                toEdit.putString(Constants.strShUserShopSelected, Constants.strShUserShopDay);
                toEdit.commit();
                Intent intentGifts=new Intent(EventCategoriesActivity.this, Day2DayCategoriesActivity.class);
                startActivity(intentGifts);
                finish();
                overridePendingTransition(R.anim.slide_right_in, R.anim.slide_right_out);
                break;
            case 11:
                ...
                toEdit.putString(Constants.strShUserShopSelected, Constants.strShUserShopGift);
                toEdit.commit();
                Intent intentDrinks=new Intent(EventCategoriesActivity.this, GiftCategoriesActivity.class);
                startActivity(intentDrinks);
                finish();
                overridePendingTransition(R.anim.slide_right_in, R.anim.slide_right_out);
                break;
            ...
            case 19:
                getDialogCoverage();
                /*Intent intentTrackOrders=new Intent(EventCategoriesActivity.this, TrackOrderListActivity.class);
    ...
    private void doLogOut() {
        final ProgressDialog pDialog=new ProgressDialog(EventCategoriesActivity.this);
        pDialog.show();
        ...
        restService.logOut(strCustId, new RestCallback<LogOutRequest>() {
            ...
            public void success(LogOutRequest responce) {
                ...
                if (reqStatus == 200 && reqSuccess == 1) {
                    ...
                    toEdit.clear();
                    toEdit.commit();*/
                    //Toast.makeText(EventCategoriesActivity.this, "Successfully Logout", Toast.LENGTH_LONG).show();
                    ...
                    Toast.makeText(EventCategoriesActivity.this, responce.getErrorMsg(), Toast.LENGTH_LONG).show();
                }
                pDialog.dismiss();
            }
    ...
    public void displayAlert(String message)
    {
        ...
        alertDialogBuilder.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                dialog.cancel();
                Intent intent=new Intent(EventCategoriesActivity.this, LoginActivity.class);
                intent.putExtra("context_act1", "webskitters.com.stockup.EventCategoriesActivity");
                finish();
                startActivity(intent);
            }
